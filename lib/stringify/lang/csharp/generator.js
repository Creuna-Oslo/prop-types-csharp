...
const generators = {
  ...
  objectOf: (name, propType, _baseClass, instantiate) => {
    ...
    const typeString = `Dictionary<string, ${valueType}>`;
    return (
      property(name, propType, typeString) +
      (instantiate ? ` = new ${typeString}();` : '')
    );
  },
