...
const getComponentName = require('./parse/common/get-component-name');
const getMeta = require('./parse/javascript/get-meta');
const getPropTypes = require('./parse/javascript/get-prop-types');
const getPropTypesIdentifierName = require('./parse/javascript/get-prop-types-identifier-name');
const parseAST = require('./parse/javascript/parse-ast');
const stripPropTypesIdentifier = require('./parse/javascript/strip-prop-types-identifier');
...
module.exports = function({
  ...
  const propTypes = parseAST(syntaxTree, propTypesMeta);
