...
const parseMemberExpression = meta => node => {
  // NOTE: This matches 'SomeComponent.propTypes.someProp'
  if (isComponentReference(node.object)) {
    return {
      ...parseType(node.property), // Name of prop
      parents: [node.object.object.name] // Name of component
    };
  }
