...
// Resolves a nested propTypesMeta property by upward traversal of propTypes tree. Given the following propTypes:
// A.propTypes = { b: { c: string } }
// If 'path' is the 'b' node of this tree, '{ c: string }' will be returned. If 'path' is 'c', 'string' is returned.
const getMetaNodeForProp = ({ path, propNames = [], propTypesMeta }) => {
  if (!propTypesMeta) {
    return;
  }
